...
public class StudentTableModel extends AbstractTableModel{
    ...
    private String[] columnNames = {"Student ID","First Name","Middle Name", "Last Name", "Student Number", "Year Level", "Has Verified"};
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            case 6:
                return data.get(rowIndex).getHas_verified();
            default:
...
//            Double.valueOf(aValue.toString()).intValue()
            switch (columnIndex){
                ...
                case 5:
                     ...
                     break;
                case 6:
                     student.setHas_verified(Boolean.valueOf((String)aValue.toString()));
                     break;
                default:
                    break;
            }
